                    ...
                    <div id="id10" class="w3-modal">
                            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                                    ...
                                    <div class="w3-center"><br>
                                      <span onclick="document.getElementById('id10').style.display='none';  $('#formularioActiv')[0].reset(); CKEDITOR.instances['description_activity'].setData(''); $('#infoPanel1').html('');"
                                    ...
                                    <?php include(__DIR__.'/../forms/formActiv.php'); ?>
