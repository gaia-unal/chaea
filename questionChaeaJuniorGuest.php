            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
									...
									<p class="text-muted">El proyecto titulado "Fortalecimiento de
										...
										es un estudio que consiste en un proceso de diseño,
										elaboración y evaluación de estrategias para el seguimiento
										valorativo de la competencia digital en contextos universitarios,
										con el fin de generar nuevas propuestas metodologías para el
										desempeño discente. Los datos aquí suministrados serán usados
										de forma anónima y solo para la caracterización de la población
										que participa en el estudio.</p>
								</div>
