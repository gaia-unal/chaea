						 ...
						 <fieldset>
				   				<legend>Agregar Actividad</legend>
						    		<div class="form-group">
										...
										<div class="form-group">
											<label for="description_activity" class=" control-label">Descripción:</label>
												<div class="has-success">
							 ...
							 <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
									 <div class="form-group">
										 <div class="col-lg-10 col-lg-offset-2">
											 <button onclick="document.getElementById('id10').style.display='none'; 	CKEDITOR.instances['description_activity'].setData(''); $('#infoPanel1').html(''); " id='closeTea' type="reset" class="btn btn-default">Cancelar</button>
