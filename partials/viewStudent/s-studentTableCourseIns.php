    ...
    <main class="detalle">
      <div id="table-box" >
        <?php  include(__DIR__.'/../viewStudent/navControlStudent.html');?>
         <div>
            <table id="dataTableCouStuIns" cellpadding="0" cellspacing="0" border="0" class="dataTable">
              <thead id="cap">
                  <tr>
            ...
            <br><br>
                  <button class="btn btn-success  btn-lg pull-right " type="button" id="addCourseIns" >Confirmar</button>
...
<script src="/chaea/js/jsn/courseSettings/s-tableCourseIns.js" charset="utf-8"></script><!--este es JSN-->
